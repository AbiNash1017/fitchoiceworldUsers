        ...
        <div className="min-h-screen bg-black py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto bg-white shadow-md rounded-lg overflow-hidden">
                <div className="px-6 py-8">
                    ...
                    <p className="text-sm text-gray-600 mb-6">Last updated: January 5th 2025</p>
                    ...
                    <div className="space-y-6">
                        ...
                        <section>
                            ...
                            <ul className="list-disc pl-6 space-y-2">
                                ...
                                <li>
                                    <strong>Website</strong> refers to Fit Choice World, accessible from <Link className="underline" href={"/"}>www.fitchoiceworld.com</Link>
                                </li>
                                <li>
                        ...
                        <section>
                            <h2 className="text-2xl font-semibold text-gray-900 mb-3">Collecting and Using Your Personal Data</h2>
                            ...
                            <ul className="list-disc pl-6 space-y-1">
                                ...
                                <li>
                                    <p><strong>Cookies Policy / Notice Acceptance Cookies
                                    </strong></p>
                                    <p>
                            ...
                            <br></br>
                            <h3 className="text-xl font-semibold text-gray-900 mb-2">Use of Your Personal Data</h3>
                            ...
                            <br></br>
                            <h3 className="text-xl font-semibold text-gray-900 mb-2">Retention of Your Personal Data
                            </h3>
                            <p>
                            ...
                            <br></br>
                            <h3 className="text-xl font-semibold text-gray-900 mb-2">Transfer of Your Personal Data
                            </h3>
                            <p>
                            ...
                            <br></br>
                            <h3 className="text-xl font-semibold text-gray-900 mb-2">Delete Your Personal Data
                            </h3>
                            <p>
                            ...
                            <br></br>
                            <h3 className="text-xl font-semibold text-gray-900 mb-2">Disclosure of Your Personal Data
                            </h3>
                            <h4 className="text-lg font-semibold text-gray-900 mb-2">Business Transactions
                            </h4>
                            <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>

                            <h4 className="text-lg font-semibold text-gray-900 mb-2">Law enforcement
                            </h4>
                            <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>

                            <h4 className="text-lg font-semibold text-gray-900 mb-2">Other legal requirements
                            </h4>
                            ...
                            <br></br>
                            <h3 className="text-xl font-semibold text-gray-900 mb-2">Security of Your Personal Data
                            </h3>
                            <p>
                        ...
                        <section>
                            <h2 className="text-2xl font-semibold text-gray-900 mb-3">Children's Privacy
                            </h2>
                            <p>
                        ...
                        <section>
                            <h2 className="text-2xl font-semibold text-gray-900 mb-3">Links to Other Websites
                        ...
                        <section>
                            <h2 className="text-2xl font-semibold text-gray-900 mb-3">Changes to this Privacy Policy
