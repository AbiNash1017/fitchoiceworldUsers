...
const TermsAndConditions = () => {
    return (
        <PolicyLayout title="Terms and Conditions" lastUpdated="January 18th 2026">
            ...
            <section>
                ...
                <ul className="list-disc pl-6 space-y-4">
                    ...
                    <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to the Fit Choice World.</li>
